 ...
 * @version 0.1
 */
public class EventBusProgressUtility {
	public static ProgressDialog progress_Dialog;
	static String progress_title = "Loading";
	...
	public static void showProgress(Context activity, String message) {
		progress_Dialog = ProgressDialog.show(activity, progress_title, message, true,false);
	}
